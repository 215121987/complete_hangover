package com.hangover.ashqures.hangover.auth;

import android.content.Context;
import android.content.Intent;
import android.content.SharedPreferences;

import com.hangover.ashqures.hangover.activity.LoginActivity;
...
public class SessionManager {
    ...
    public void checkLogin(){
        ...
        if(!this.isLoggedIn()){
            ...
            Intent i = new Intent(_context, LoginAndSignUpActivity.class);
